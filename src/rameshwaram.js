...
import z1 from './/video/Rameshwaram.jpg';
...
function Rameshwaram(){
    return (
        ...
        <p style={{textAlign: "center",color:"orange",fontWeight:"700",fontSize:"35px"}}>RAMESHWARAM</p>
        <div class="info" style={{fontSize:"14px",paddingBottom:"60px",marginBottom:"40px"}}>
            <div class="content-1" style={{width:"100%"}}>
               <p><img src={`${z1}`} style={{float:"left",marginRight:"10px",height:"300px",width:"500px",boxSizing:"border-box"}}></img><strong>Rameshwaram</strong> is a holiday paradise on India's west coast. Come to Goa for an Holiday and you won't be disappointed. Goa has something to offer every tourist.</p>               
               <p>For the night birds, Sri Lanka has the most active night life among South Asian Countries. It somewhat resembles Las Vegas as it has a fair share of casinos and clubs that never sleep. Discos and 'real' Night clubs are a plenty. Last but not least, alcohol flows very freely in Sri Lanka.</p>
               <p>If its sun, sand and sea that you're looking for, Rameshwaram's got it all in abundance. Miles of golden sandy expanses stretch along the west coast of India, beside the Arabian Sea. The rolling waves wash the beaches of Goa, on which sunbathers, holiday travelers and the local residents of Goa relax and have the time of their lives.</p>
                <p>It is famous the world over for the unique charm of its beaches. The famous beaches Calangute, Miramar, Dona Paula, Agonda, Aguada, Benaulim and Colva to name a few, were sought after by hippies and flower children in the 1970's. Today Goa's beaches attract International tourists who seek a place to relax and unwind in the sunny weather of Goa, India.</p>
               <p>A lover's paradise, Sri Lanka has it all - exquisite underwater coral scrapes, cascading waterfalls, colorful festivals and pageantry, magnificent ancient cities and the flowers in all their glory. Apart from scenic beauty, sparkling gems like sapphires, ruby's, or a myriad of other exotic stones are found in abundance Sri Lanka. You can gift them to your beloved as a token of your love and appreciation.</p>
