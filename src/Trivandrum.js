...
import z1 from './/video/trivandrum.jpg';
import z2 from './/video/kanyakumari.jpg';
...
function Trivandrum(){
    return (
        ...
        <p style={{textAlign: "center",color:"orange",fontWeight:"700",fontSize:"35px"}}>TRIVANDRUM - KANYAKUMARI</p>
        <div class="info" style={{fontSize:"14px"}}>
            <div>
               <p><img src={`${z1}`} style={{float:"left",marginRight:"10px",height:"300px",width:"500px",boxSizing:"border-box"}}></img><strong>Trivandrum</strong> It is known as the city of gardens because of abundance of beautiful lush green, well laid gardens. Another nickname, which it has gained due to its Increasing IT industry, is Silicon Valley of India.</p>
            ...
            <div class="content-1" style={{width:"100%"}}>
               <p><img src={`${z2}`} style={{float:"right",marginLeft:"10px",height:"300px",width:"500px",boxSizing:"border-box"}}></img><strong>Kanyakumari</strong> is a holiday paradise on India's west coast. Come to Goa for an Holiday and you won't be disappointed. Goa has something to offer every tourist.</p>               
