...
import z1 from './/video/MAURITIUS.jpg';
...
function Maldives(){
    return (
        ...
        <p style={{textAlign: "center",color:"orange",fontWeight:"700",fontSize:"35px"}}>MALDIVES</p>
        <div class="info" style={{fontSize:"14px",paddingBottom:"60px",marginBottom:"40px"}}>
            <div class="content-1" style={{width:"100%"}}>
               <p><img src={`${z1}`} style={{float:"left",marginRight:"10px",height:"300px",width:"500px",boxSizing:"border-box"}}></img><strong>Maldives</strong> is a holiday paradise on India's west coast. Come to Goa for an Holiday and you won't be disappointed. Goa has something to offer every tourist.</p>               
               <p>For the night birds, Maldives has the most active night life among South Asian Countries. It somewhat resembles Las Vegas as it has a fair share of casinos and clubs that never sleep. Discos and 'real' Night clubs are a plenty. Last but not least, alcohol flows very freely in Sri Lanka.</p>
               <p>If its sun, sand and sea that you're looking for, Maldives's got it all in abundance. Miles of golden sandy expanses stretch along the west coast of India, beside the Arabian Sea. The rolling waves wash the beaches of Goa, on which sunbathers, holiday travelers and the local residents of Goa relax and have the time of their lives.</p>
