...
import z3 from './/video/KASHMIR.jpg';
import { Link } from 'react-router-dom';
// import './Agra-delhi.css';
function Agradelhikashmir(){
    return (
        <> 
        <div class="header">
        ...
        <p style={{textAlign: "center",color:"orange",fontWeight:"700",fontSize:"35px"}}>AGRA - DELHI - KASHMIR</p>
...
export default Agradelhikashmir; 