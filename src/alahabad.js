...
import z1 from './/video/alahabad.jpg';
import z2 from './/video/varanasi (1).jpg';
import z3 from './/video/kathmandu.jpg';
...
function Alahabad(){
    return (
        ...
        <p style={{textAlign: "center",color:"orange",fontWeight:"700",fontSize:"35px"}}>ALAHABAD - VARANASI - KATHMANDU</p>
        <div class="info" style={{fontSize:"14px"}}>
            <div class="content-1" style={{width:"100%"}}>
               <p><img src={`${z1}`} style={{float:"left",marginRight:"10px",height:"300px",width:"500px",boxSizing:"border-box"}}></img><strong>Alahabad</strong> Cochin aka Kochi is the Commercial and industrial capital of Kerala. Famous as Queen of Arabian Sea , Kochi is situated on the coast of the Arabian Sea in central Kerala, a city with mélange of several exotic cultures like the Portuguese, Jewish, English, French, Dutch and Chinese.</p>
            ...
            <br></br>
            <div>
               <p><img src={`${z3}`} style={{float:"left",marginRight:"10px",height:"250px",width:"500px",boxSizing:"border-box"}}></img><strong>Kathmandu</strong> Thekaddy, also known as Periyar, is home to the famous Periyar Wildlife Sanctuary and Tiger Reserve.</p>
