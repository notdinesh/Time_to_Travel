...
import z1 from './/video/KODAIKANAL-FALLS.jpg';
import z2 from './/video/THEKADI-1.jpg';
...
function Kodaikanal(){
    return (
        ...
        <p style={{textAlign: "center",color:"orange",fontWeight:"700",fontSize:"35px"}}>KODAIKANAL-FALLS - THEKADI</p>
        <div class="info" style={{fontSize:"14px"}}>
            <div class="content-1" style={{width:"100%"}}>
               <p><img src={`${z1}`} style={{float:"left",marginRight:"10px",height:"300px",width:"500px",boxSizing:"border-box"}}></img><strong>Kodaikanal</strong>  aka Kochi is the Commercial and industrial capital of Kerala. Famous as Queen of Arabian Sea , Kochi is situated on the coast of the Arabian Sea in central Kerala, a city with mélange of several exotic cultures like the Portuguese, Jewish, English, French, Dutch and Chinese.</p>
