...
import z1 from './/video/hyderabad.jpg';
import z2 from './/video/ajanta.jpg';
import z3 from './/video/MUMBAI.jpg';
import { Link } from 'react-router-dom';
// import './Agra-delhi.css';
function Hyderabadajanta(){
    return (
        <>
        <div class="header">
        ...
        <p style={{textAlign: "center",color:"orange",fontWeight:"700",fontSize:"35px"}}>HYDERABAD - AJANTA - MUMBAI</p>
        <div class="info" style={{fontSize:"14px"}}>
            <div class="content-1" style={{width:"100%",fontSize:"14px"}}>
               <p><img src={`${z1}`} style={{float:"left",marginRight:"10px",height:"300px",width:"500px",boxSizing:"border-box"}}></img><strong>HYDERABAD</strong> - a rich history, delightful tourist attractions and a vibrant presence - that is Agra for you. Though the city has come a long way since its days as a Mughal stronghold, it still retains its old worldly feel that simply delights every visitor. Moreover, the tourist attractions in Agra are such that one simply cannot have enough of them.</p>
...
export default Hyderabadajanta; 