...
import z1 from './/video/visakapatnam.jpg';
import z2 from './/video/hyderabad.jpg';
import { Link } from 'react-router-dom';
// import './Agra-delhi.css';
function Vishakhapatnam(){
    return (
        <>
        <div class="header">
        ...
        <p style={{textAlign: "center",color:"orange",fontWeight:"700",fontSize:"35px"}}>VISAKAPATNAM - HYDERABAD</p>
        <div class="info" style={{fontSize:"14px"}}>
            <div>
               <p><img src={`${z1}`} style={{float:"left",marginRight:"10px",height:"300px",width:"500px",boxSizing:"border-box"}}></img><strong>Vishakhapatnam</strong> It is known as the city of gardens because of abundance of beautiful lush green, well laid gardens. Another nickname, which it has gained due to its Increasing IT industry, is Silicon Valley of India.</p>
               <p>Perhaps Bangalore is the most sought after tourist destination of south India. Climate of Bangalore is so pleasant that you can have tours to Bangalore at any time of the year. There is everything to offer on tours to Bangalore. It has natural lakes, beautiful gardens and parks, shopping malls, pubs, monuments etc.</p> 
            </div>
            <br></br>
            <br></br>
            <br></br>
            ...
            <div class="content-1" style={{width:"100%"}}>
               <p><img src={`${z2}`} style={{float:"right",marginLeft:"10px",height:"300px",width:"500px",boxSizing:"border-box"}}></img><strong>Hyderabad</strong> is a holiday paradise on India's west coast. Come to Goa for an Holiday and you won't be disappointed. Goa has something to offer every tourist.</p>               
